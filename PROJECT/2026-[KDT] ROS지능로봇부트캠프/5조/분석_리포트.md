# 5조 : pwm_control_with_TXRX_dma 프로젝트 분석 리포트
...
# 2. MediaPipe 설치 (pip만 가능, conda 미지원)
...
# 4. 실행
python human_recognition.py
```

```
$ cd "C:\Users\Administrator\Desktop\새 폴더 (2)\2.최종-20260630T202912Z-3-001\2.최종\5조\SW"
...
# yolov3-tiny.cfg
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/pjreddie/darknet/master/cfg/yolov3-tiny.cfg" -OutFile "yolov3-tiny.cfg" -UseBasicParsing

# yolov3-tiny.weights (조금 큼 ~33MB)
Invoke-WebRequest -Uri "https://pjreddie.com/media/files/yolov3-tiny.weights" -OutFile "yolov3-tiny.weights" -UseBasicParsing
```
