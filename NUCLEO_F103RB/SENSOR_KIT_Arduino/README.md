...
| 06 | 릴레이 모듈 | 릴레이 ON/OFF 제어 | `06.relay_module` |
| 07 | 레이저 모듈 | 레이저 다이오드 제어 | `07.sound_sensor_high` | 
| 08 | 버튼 스위치 모듈 | 디지털 입력 + 디바운싱 | `08.sound_sensor_small` |
| 09 | 터치 센서 모듈 | 정전식 터치 입력 | `09.tracking_module` |
| 10 | 충격 센서 모듈 | 진동/충격 감지 | `10.obstacle_sensor` |
| 11 | 노크 센서 모듈 | 압전 소자 진동 감지 |`11_Flame_Sensor` | 
