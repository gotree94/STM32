...
| 34 | [조이스틱](./34_Joystick/) | 조이스틱 | `34_Joystick` |
| 37 | [수동부저](./37_Passive_Buzzer/) | 수동부저 | `37_Passive_Buzzer` |
| 38 | [로터리 스위치](./38_Rotary_Encoder/) | 로터리 스위치 | `38_Rotary_Encoder` |
| 39 | [피에조](./39_Active_Buzzer/) | 피에조 | `39_Active_Buzzer` |
