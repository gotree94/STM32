/* ============================================================================
 * STM32F103 + ST7735S - Vector Robot Eye Animation
 * ★ 안정적 고속 버전 - HAL + 버퍼 ★
 * ============================================================================
 */
...
#define EYE_AREA_Y      30 //10
#define EYE_AREA_W      140
#define EYE_AREA_H      60

// 눈 위치 (버퍼 내 좌표)
#define LX              40      // 왼쪽 눈 중심 (버퍼 기준)
#define RX              100     // 오른쪽 눈 중심 (버퍼 기준)
#define CY              30      // 눈 중심 Y (버퍼 기준)
...
void SystemClock_Config(void) {
    ...
    RCC_OscInitStruct.PLL.PLLMUL = RCC_PLL_MUL8;  // 64MHz
