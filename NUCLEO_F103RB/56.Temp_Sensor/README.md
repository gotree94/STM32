...
## KY-028 Arduino 코드
  ...
  * 아날로그 출력 핀이 가변 저항에 직접 연결되어 있으므로 KY-013에서와 같이 Steinhart-Hart 방정식을 사용하여 온도를 계산할 수 없으며, 이 값을 사용하여 온도의 상대적 변화만 측정할 수 있습니다.
...
![](002.png)
   ...
   * 주변 온도를 연속적인 전압으로 변환하여 Arduino가 아날로그(ADC) 핀에서 읽은 다음 Steinhart-Hart 방정식을 사용하여 정밀한 값으로 변환합니다.
...
## KY-013 사양
  ...
  * Arduino는 분배기의 출력 전압을 아날로그 핀에서 읽고 Steinhart-Hart 방정식(또는 아래 나열된 B-값을 사용하는 더 간단한 Beta 방정식)을 사용하여 온도로 변환합니다.
