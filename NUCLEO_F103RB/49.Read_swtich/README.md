...
|:-------------------------:|:-------------------------:|
| 자석이 리드 스위치와 평행한 경우 이것이 리드 스위치와 자석 사이의 완벽한 구성이다. | 자석이 리드 스위치와 수직인 경우 이 구성에서는 자기장이 리드 스위치 중간에 사각지대(데드 존)를 갖게 된다. |
| 축적된 자기장이 포물선 형태이기 때문이다. 문이나 창문용 리드 스위치에서도 이 구성을 찾을 수 있다. | 따라서 자석과 리드 스위치를 수직 구성으로 사용하지 않는 것이 좋다. |
