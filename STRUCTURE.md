...
1. Private Type Definitions)   -   사용자 정의 자료형(struct, enum, typedef 등)
2.  Private Defines)  -   매크로 상수(#define)
3.  Private Macros)   -   함수형 매크로
4.  Private Variables)   -   전역 변수(static 포함)
5.  Private Function Prototypes)   - 함수 원형 선언
